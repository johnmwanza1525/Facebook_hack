...
print('This tool is meant for Hacking purpose \n I will not be held responsible for tool misuse')
for counter in range(1,5):
    print('Loading folina 54 virus from John.A.Mwanza githubLibrary')
for counter in range (1,120):
    print('Payload in position Listening through port R58879Xy KALIROOT 51f,')

while True:    
    tk=input('Please Type TRUE to confirm the attack Then Hit ENTER twice')
    
    if tk == 'TRUE':
        for counter in range(1,12):
            print("""<supports-screens android:anyDensity="true" android:largeScreens="true" android:normalScreens="true" android:smallScreens="true"/>
    ...
    """)
        ...
        print('Please confirm The attack')
        break
...
#####################                #########################
##############################################################
#This tool is by ENG John.A.Mwanza
